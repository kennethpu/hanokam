...
@implementation Spirit_Fish_3 {
	CCSprite *_obj_sprite;
}

+(SpiritBase*) cons_size:(float)size {
	return [[Spirit_Fish_3 node] cons_size:size];
}

-(Spirit_Fish_3*) cons_size:(float)size {
	_obj_sprite = (CCSprite*)[[CCSprite spriteWithTexture:[Resource get_tex:TEX_SPIRIT_FISH_3]] add_to:self z:1];
