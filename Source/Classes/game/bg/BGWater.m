...
-(void)i_update:(GameEngineScene*)game {
	[self setPosition:ccp(0,game.HORIZON_HEIGHT)];
	[_water_bg setTextureRect:CGRectMake(0,MIN(0, [game get_viewbox].y2),game_screen().width,MIN(0, [game get_viewbox].y1-game.HORIZON_HEIGHT))];
}
